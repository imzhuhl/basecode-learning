...
namespace basecode {
    ...
    bool instruction_emitter::nop(result &r) {
        ...
        size_t inst_size = _terp->encode_instruction(r, _location_counter, no_op);
        if (inst_size == 0)
            return false;
    ...
    bool instruction_emitter::add_int_register_to_register(result& r, op_sizes size, uint8_t target_index,
    ...
    bool instruction_emitter::move_int_constant_to_register(result &r, op_sizes size, uint64_t value, uint8_t index) {
    ...
    bool instruction_emitter::load_stack_offset_to_register(result &r, uint8_t target_index, uint64_t offset) {
    ...
    bool instruction_emitter::store_register_to_stack_offset(result& r, uint8_t source_index, uint64_t offset) {
    ...
    bool instruction_emitter::multiply_int_register_to_register(result& r, op_sizes size, uint8_t target_index,
                                                                uint8_t lhs_index, uint8_t rhs_index) {
